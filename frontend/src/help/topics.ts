...
export const helpTopics: HelpTopic[] = [
  { id: 'general-concepts', title: 'General Concepts', load: md(() => import('./general-concepts.md?raw')) },
  {
    ...
    children: [
      ...
      { id: 'ingester-scatterbox', title: 'Scatterbox', load: md(() => import('./ingester-scatterbox.md?raw')) },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      { id: 'inspector-storages', title: 'Storages', load: md(() => import('./inspector-storages.md?raw')) },
      { id: 'inspector-pipeline-stages', title: 'Pipeline stages', load: md(() => import('./inspector-pipeline-stages.md?raw')) },
      { id: 'inspector-routes', title: 'Routes', load: md(() => import('./inspector-routes.md?raw')) },
