...
- **Expression**: A boolean expression like `level=error AND env=prod` (see [Query Language](help:query-language) for syntax). Only matching records are routed to this store.
