/**
 * Icon registry for help markdown content.
 *
 * Usage in .md files:  ![icon:bookmark]()
 *
 * The HelpDialog markdown renderer intercepts images whose alt text
 * starts with "icon:" and renders the matching inline SVG instead.
 */

import type { ReactNode } from "react";

/** SVG inner content keyed by icon name. */
const helpIcons: Record<string, ReactNode> = {
  ...
  inspector: <polyline points="22 12 18 12 15 21 9 3 6 12 2 12" />,
  "sort-asc": (
    <>
      <path d="M12 5v14" />
