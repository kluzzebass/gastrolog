...
export const SEVERITIES: Record<SeverityLevel, SeverityDef> = {
  error: {
    ...
    toggleActive: "bg-severity-error border-severity-error text-severity-error-text",
  ...
  warn: {
    ...
    toggleActive: "bg-severity-warn border-severity-warn text-severity-warn-text",
  ...
  info: {
    ...
    toggleActive: "bg-severity-info border-severity-info text-severity-info-text",
  ...
  debug: {
    ...
    toggleActive: "bg-severity-debug border-severity-debug text-severity-debug-text",
  ...
  trace: {
    ...
    toggleActive: "bg-severity-trace border-severity-trace text-severity-trace-text",
