  ...
  return (
    <div className="p-4 space-y-4">
      ...
      <DetailSection
        ...
        dark={dark}
        action={
          onContextZoomOut && !contextLoading ? (
            <button
              onClick={onContextZoomOut}
              title="Show more context"
              className={`w-5 h-5 flex items-center justify-center rounded transition-colors ${c(
