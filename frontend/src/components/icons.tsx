...
export function SlidersIcon({ className }: Readonly<IconProps>) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function ClusterIcon({ className }: Readonly<IconProps>) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function FilesIcon({ className }: Readonly<IconProps>) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
/** Alias for ServiceIcon — same gear/cog SVG. */
export const CogIcon = ServiceIcon;

export function PulseIcon({ className }: Readonly<IconProps>) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
...
export function StorageIcon({ className }: Readonly<IconProps>) {
  return (
    <svg
      viewBox="0 0 24 24"
      fill="none"
