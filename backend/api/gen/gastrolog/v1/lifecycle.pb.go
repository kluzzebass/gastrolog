...
func (x *AckAlarmRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AckAlarmRequest) ProtoMessage() {}

func (x *AckAlarmRequest) ProtoReflect() protoreflect.Message {
	mi := &file_gastrolog_v1_lifecycle_proto_msgTypes[18]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AckAlarmRequest.ProtoReflect.Descriptor instead.
func (*AckAlarmRequest) Descriptor() ([]byte, []int) {
	return file_gastrolog_v1_lifecycle_proto_rawDescGZIP(), []int{18}
}

func (x *AckAlarmRequest) GetAlarmId() []byte {
	if x != nil {
		return x.AlarmId
	}
	return nil
...
func (x *AckAlarmRequest) GetAckedBy() string {
	if x != nil {
		return x.AckedBy
	}
	return ""
...
func (x *AckAlarmRequest) GetLocalOnly() bool {
	if x != nil {
		return x.LocalOnly
	}
	return false
...
func (x *AckAlarmResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AckAlarmResponse) ProtoMessage() {}

func (x *AckAlarmResponse) ProtoReflect() protoreflect.Message {
	mi := &file_gastrolog_v1_lifecycle_proto_msgTypes[19]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AckAlarmResponse.ProtoReflect.Descriptor instead.
func (*AckAlarmResponse) Descriptor() ([]byte, []int) {
	return file_gastrolog_v1_lifecycle_proto_rawDescGZIP(), []int{19}
}

func (x *AckAlarmResponse) GetApplied() uint32 {
	if x != nil {
		return x.Applied
	}
	return 0
...
const file_gastrolog_v1_lifecycle_proto_rawDesc = "" +
	...
	"\vtransferred\x18\x01 \x01(\bR\vtransferred\"f\n" +
	"\x0fAckAlarmRequest\x12\x19\n" +
	"\balarm_id\x18\x01 \x01(\fR\aalarmId\x12\x19\n" +
	"\backed_by\x18\x02 \x01(\tR\aackedBy\x12\x1d\n" +
	"\n" +
	"local_only\x18\x03 \x01(\bR\tlocalOnly\",\n" +
	"\x10AckAlarmResponse\x12\x18\n" +
	"\aapplied\x18\x01 \x01(\rR\aapplied\"\x98\x01\n" +
...
var file_gastrolog_v1_lifecycle_proto_goTypes = []any{
	...
	(*AckAlarmRequest)(nil),           // 21: gastrolog.v1.AckAlarmRequest
	(*AckAlarmResponse)(nil),          // 22: gastrolog.v1.AckAlarmResponse
	(*ShelveAlarmRequest)(nil),        // 23: gastrolog.v1.ShelveAlarmRequest
