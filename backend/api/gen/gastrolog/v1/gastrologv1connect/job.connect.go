...
const (
	...
	JobServiceName = "gastrolog.v1.JobService"
)
...
func NewJobServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) JobServiceClient {
	...
	jobServiceMethods := v1.File_gastrolog_v1_job_proto.Services().ByName("JobService").Methods()
...
// ListJobs calls gastrolog.v1.JobService.ListJobs.
...
func (UnimplementedJobServiceHandler) GetJob(context.Context, *connect.Request[v1.GetJobRequest]) (*connect.Response[v1.GetJobResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("gastrolog.v1.JobService.GetJob is not implemented"))
}
