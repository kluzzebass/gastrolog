...
func TestPlacementSingleNodeMemoryTier(t *testing.T) {
	...
	vaultID := glid.New()
	tierID := glid.New()
	_ = store.PutTier(ctx, system.TierConfig{ID: tierID, Name: "mem", Type: system.VaultTypeMemory, VaultID: vaultID})
...
func TestPlacementLocalTierRequiresStorageClass(t *testing.T) {
	...
	vaultID := glid.New()
	tierID := glid.New()
	_ = store.PutTier(ctx, system.TierConfig{ID: tierID, Name: "local", Type: system.VaultTypeFile, StorageClass: 1, VaultID: vaultID})
	_ = store.PutVault(ctx, system.VaultConfig{ID: vaultID, Name: "v"})
...
func TestPlacementCloudTierMatchesActiveChunkClass(t *testing.T) {
	...
	_ = store.PutTier(ctx, system.TierConfig{
		...
		CloudServiceID: &csID, StorageClass: 2, VaultID: vaultID,
	})
	_ = store.PutVault(ctx, system.VaultConfig{ID: vaultID, Name: "v"})
...
func TestPlacementNoEligibleNodeClearsAssignment(t *testing.T) {
	...
	vaultID := glid.New()
	tierID := glid.New()
	_ = store.PutTier(ctx, system.TierConfig{ID: tierID, Name: "local", Type: system.VaultTypeFile, StorageClass: 5, VaultID: vaultID})
	_ = store.PutVault(ctx, system.VaultConfig{ID: vaultID, Name: "v"})
...
func TestPlacementLoadBalances(t *testing.T) {
	...
	vaultID := glid.New()
	tier1 := glid.New()
	_ = store.PutTier(ctx, system.TierConfig{ID: tier1, Name: "t1", Type: system.VaultTypeMemory, VaultID: vaultID})

	tier2 := glid.New()
	_ = store.PutTier(ctx, system.TierConfig{ID: tier2, Name: "t2", Type: system.VaultTypeMemory, VaultID: vaultID})
...
func TestPlacementLoadBalancesAcrossThreeNodes(t *testing.T) {
	...
	for i := 0; i < 6; i++ {
		tid := glid.New()
		_ = store.PutTier(ctx, system.TierConfig{ID: tid, Name: "t", Type: system.VaultTypeMemory, VaultID: vaultID})
...
func TestPlacementUnknownTierType(t *testing.T) {
	...
	vaultID := glid.New()
	tierID := glid.New()
	_ = store.PutTier(ctx, system.TierConfig{ID: tierID, Name: "weird", Type: "quantum", VaultID: vaultID})
	_ = store.PutVault(ctx, system.VaultConfig{ID: vaultID, Name: "v"})
...
func TestPlacementLocalTierStorageClassZero(t *testing.T) {
	...
	_ = store.PutTier(ctx, system.TierConfig{ID: tierID, Name: "local", Type: system.VaultTypeFile, StorageClass: 0, VaultID: vaultID})
	_ = store.PutVault(ctx, system.VaultConfig{ID: vaultID, Name: "v"})
...
func TestPlacementCloudTierActiveChunkClassZero(t *testing.T) {
	...
	_ = store.PutTier(ctx, system.TierConfig{
		ID: tierID, Name: "cloud", Type: system.VaultTypeFile,
		CloudServiceID: &csID, StorageClass: 0, VaultID: vaultID,
	})
	_ = store.PutVault(ctx, system.VaultConfig{ID: vaultID, Name: "v"})
...
func TestPlacementTierSharedByMultipleVaults(t *testing.T) {
	...
	vault2ID := glid.New()
	tierID := glid.New()
	_ = store.PutTier(ctx, system.TierConfig{ID: tierID, Name: "shared", Type: system.VaultTypeMemory, VaultID: vault1ID})
...
func TestPlacementMultipleTiersDifferentTypes(t *testing.T) {
	...
	vaultID := glid.New()
	memTier := glid.New()
	_ = store.PutTier(ctx, system.TierConfig{ID: memTier, Name: "mem", Type: system.VaultTypeMemory, VaultID: vaultID})

	localTier := glid.New()
	_ = store.PutTier(ctx, system.TierConfig{ID: localTier, Name: "local", Type: system.VaultTypeFile, StorageClass: 1, VaultID: vaultID})
...
func TestPlacementNodeWithMultipleStorageClasses(t *testing.T) {
	...
	vaultID := glid.New()
	tier1 := glid.New()
	_ = store.PutTier(ctx, system.TierConfig{ID: tier1, Name: "fast", Type: system.VaultTypeFile, StorageClass: 1, VaultID: vaultID})

	tier2 := glid.New()
	_ = store.PutTier(ctx, system.TierConfig{ID: tier2, Name: "slow", Type: system.VaultTypeFile, StorageClass: 3, VaultID: vaultID})
...
func TestPlacementRF2AssignsSecondary(t *testing.T) {
	...
	vaultID := glid.New()
	tierID := glid.New()
	_ = store.PutTier(ctx, system.TierConfig{ID: tierID, Name: "mem", Type: system.VaultTypeMemory, ReplicationFactor: 2, VaultID: vaultID})
	_ = store.PutVault(ctx, system.VaultConfig{ID: vaultID, Name: "v"})
...
func TestPlacementRF1NoSecondaries(t *testing.T) {
	...
	vaultID := glid.New()
	tierID := glid.New()
	_ = store.PutTier(ctx, system.TierConfig{ID: tierID, Name: "mem", Type: system.VaultTypeMemory, ReplicationFactor: 1, VaultID: vaultID})
	_ = store.PutVault(ctx, system.VaultConfig{ID: vaultID, Name: "v"})
...
func TestPlacementRF3InsufficientNodes(t *testing.T) {
	...
	vaultID := glid.New()
	tierID := glid.New()
	_ = store.PutTier(ctx, system.TierConfig{ID: tierID, Name: "mem", Type: system.VaultTypeMemory, ReplicationFactor: 3, VaultID: vaultID})
	_ = store.PutVault(ctx, system.VaultConfig{ID: vaultID, Name: "v"})
