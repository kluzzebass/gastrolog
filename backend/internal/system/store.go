...
type Store interface {
	...
	GetVaultPlacements(ctx context.Context, instID glid.GLID) ([]VaultPlacement, error)
	SetVaultPlacements(ctx context.Context, instID glid.GLID, placements []VaultPlacement) error
