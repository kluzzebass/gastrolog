...
func TestPutIngester(t *testing.T) {
	...
	got := roundTripCommand(t, NewPutIngester(want), func(cmd *gastrologv1.SystemCommand) (system.IngesterConfig, error) {
...
func TestPutCertificate(t *testing.T) {
	...
	got := roundTripCommand(t, NewPutCertificate(want), func(cmd *gastrologv1.SystemCommand) (system.CertPEM, error) {
...
func TestCreateUser(t *testing.T) {
	...
	got := roundTripCommand(t, NewCreateUser(want), func(cmd *gastrologv1.SystemCommand) (system.User, error) {
...
func TestCreateRefreshToken(t *testing.T) {
	...
	got := roundTripCommand(t, NewCreateRefreshToken(want), func(cmd *gastrologv1.SystemCommand) (system.RefreshToken, error) {
...
func TestSnapshotRoundTrip(t *testing.T) {
	...
	cfg := &system.Config{
		...
		RetentionPolicies: []system.RetentionPolicyConfig{
			{ID: retPolicyID, Name: "30d", MaxAge: ptr("720h"), MaxSize: ptr("50GB")},
		},
...
func roundTripCommand[T any](t *testing.T, cmd *gastrologv1.SystemCommand, extract func(*gastrologv1.SystemCommand) (T, error)) T {
	t.Helper()
	b, err := Marshal(cmd)
	if err != nil {
		t.Fatalf("Marshal: %v", err)
