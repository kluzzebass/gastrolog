...
func testRetentionPolicies(t *testing.T, newStore func(t *testing.T) system.Store) {
	...
	t.Run("TierOwnership", func(t *testing.T) {
		s := newStore(t)
		ctx := context.Background()
		...
		got1, err := s.GetTier(ctx, tierID1)
		if err != nil {
			t.Fatalf("GetTier t1: %v", err)
		}
...
func testTiers(t *testing.T, newStore func(t *testing.T) system.Store) {
