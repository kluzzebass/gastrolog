...
// snapshot install, leader-only categories on lead-gained and — since
// gastrolog-235dm7 — on a placement move under a stable leader); this
// tick is the safety net for dropped/raced events plus the two categories
// that are periodic-by-nature (idle-active inactivity, grace-period GCs).
